...
public class ClassArr001 {
	public static void main(String[] args) {
		...
		carr[0] = new A1();  // 1) new 메모리빌리고, 객체생성  2) A1() 초기화 시 3) carr[0] 번지
		carr[0].name = "apple"; System.out.println(carr[0].name);
		
		carr[1] = new A1();  // 1) new 메모리빌리고, 객체생성  2) A1() 초기화 시 3) carr[0] 번지
		carr[1].name = "banana"; System.out.println(carr[1].name);
		
		carr[2] = new A1();  // 1) new 메모리빌리고, 객체생성  2) A1() 초기화 시 3) carr[0] 번지
