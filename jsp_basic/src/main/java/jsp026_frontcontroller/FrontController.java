...
public class FrontController extends HttpServlet {
	...
	// #4-1. 브라우저띄우기 - ctrl + fll : http://localhost:8080/jsp_basic/*.front
	// #4-2. http://localhost:8080/jsp_basic/a.front  콘솔창확인  	/a.basic
	// #4-2. http://localhost:8080/jsp_basic/b.front			/b.basic
}