...
<!--  END HEADER -->
<script>
// window.onload = function(){}; 브라우저로딩 작업   여러번 쓸 경우 맨마지막 1번만
		...
		<tbody>
			<c:forEach var="dto" items="${list}" varStatus="status">
				<tr>
					...
					<td>
						<a href="${pageContext.request.contextPath}/board/detail?bno=${dto.bno}">${dto.btitle}</a> <!-- board/detail?bno=${dto.bno} -->
					</td>
					<td>${dto.bname}</td>
					<td>${dto.bdate}</td>
					<td>${dto.bhit}</td>
